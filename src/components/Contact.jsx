...
const Contact = () => {
  return (
    <div>
      <section class="relative z-10 overflow-hidden bg-white sm:py-32 lg:py-[120px] ">
            ...
            <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div class="mb-12 max-w-[570px] lg:mb-0">
                ...
                <p class="text-body-color mb-9 text-base leading-relaxed">
                  We are always ready to serve you. You can contact us through
                  the following means.
                </p>
                ...
                <div class="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div class="w-full">
                    ...
                    <p class="text-body-color text-base">(+233) 05599 999 99</p>
                  </div>
                </div>
                <div class="mb-8 flex w-full max-w-[370px]">
                  <div class="bg-primary text-primary mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]">
              ...
              <div class="relative rounded-lg bg-white p-8 shadow-lg sm:p-12">
                <form>
                  ...
                  <div>
                    <button
                      type="submit"
                      class="bg-yellow-600 border-primary w-full rounded border p-3  transition hover:bg-opacity-90"
                    >
                      Send Message
                    </button>
                  </div>
                ...
                <div>
                  <span class="absolute -top-10 -right-9 z-[-1]"></span>
